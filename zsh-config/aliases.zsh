if [[ `uname` == 'Darwin' ]]; then
    ...
    export PATH="$(brew --prefix openjdk)/bin:$(brew --prefix sqlite)/bin:$(brew --prefix grep)/bin:$HOME/.dotfiles/bin/darwin:$HOME/.dotfiles/android_env/android-platform-tools/darwin:$HOME/.dotfiles/android_env/bin/darwin:$PATH"
    ...
    export PATH="$HOME/.dotfiles/bin/linux:$HOME/.dotfiles/android_env/bin/linux:$HOME/.dotfiles/android_env/android-platform-tools/linux:$PATH"
fi
